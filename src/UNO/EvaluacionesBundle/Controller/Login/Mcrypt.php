...
class Mcrypt{
    ...
    public static function encrypt($pureString) {
        ...
        return trim(base64_encode(mcrypt_encrypt(MCRYPT_RIJNDAEL_256, static::$_key, $pureString, MCRYPT_MODE_ECB, mcrypt_create_iv(mcrypt_get_iv_size(MCRYPT_RIJNDAEL_256, MCRYPT_MODE_ECB), MCRYPT_RAND))));
    }
