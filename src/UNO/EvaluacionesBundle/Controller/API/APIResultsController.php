...
class APIResultsController extends Controller{
    ...
    private function getResQuery($parameters, $where){
        ...
        $_surveyResultSurveyPerson = $qb
            ...
            ->leftJoin('UNOEvaluacionesBundle:Log','L', 'WITH', "S.surveyid = L.surveySurveyid AND P.personid = L.personPersonid")
            ...
            ->leftJoin('UNOEvaluacionesBundle:Question','Q', 'WITH', 'QS.questionQuestionid = Q.questionid')
            ->leftJoin('UNOEvaluacionesBundle:Subcategory','Sub', 'WITH', 'Q.subcategorySubcategoryid = Sub.subcategoryid')
            ->innerJoin('UNOEvaluacionesBundle:Answer','A', 'WITH', "OQ.optionxquestionId = A.optionxquestion AND P.personid = A.personPersonid")
            ...
            //->andWhere("A.answerid is not null")
            ->andWhere($where)
            ->setParameters($parameters)
            ->groupBy('PS.schoolid, P.personid, S.surveyid, Q.question, A.answerid')
            ->orderBy( 'PS.schoolid')
