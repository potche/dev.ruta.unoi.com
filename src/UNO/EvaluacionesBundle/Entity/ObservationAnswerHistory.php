 ...
 * Answer
 *
 * @ORM\Table(name="ObservationAnswerHistory")
 * @ORM\Entity
 */
class ObservationAnswerHistory
{
    /**
     * @var integer
     *
    ...
    /**
     * Set observationAnswerId
     *
     * @param integer $observationAnswerId
     *
     * @return ObservationAnswer
     */
    public function setObservationAnswerId($observationAnswerId)
    {
        $this->observationAnswerId = $observationAnswerId;
